...
export type ServiceState = 'STARTED' | 'INSTALLED' | 'STARTING' | 'STOPPING' | 'INSTALLING' | 'INSTALL_FAILED' | 'MAINTENANCE' | 'UNKNOWN' | 'INIT';
...
export type RequestStatus = 'PENDING' | 'IN_PROGRESS' | 'COMPLETED' | 'FAILED' | 'ABORTED' | 'TIMEDOUT' | 'QUEUED';
