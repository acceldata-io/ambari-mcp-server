...
export const alertToolExecutors = {
    ambari_alerts_getcurrent: async (args) => {
        ...
        if (args['state'])
            params['Alert/state'] = args['state'];
        if (args['serviceName'])
            params['Alert/service_name'] = args['serviceName'];
        if (args['hostName'])
            params['Alert/host_name'] = args['hostName'];
        if (args['maintenanceState'])
            params['Alert/maintenance_state'] = args['maintenanceState'];
        const data = await ambariGet(`/clusters/${clusterName}/alerts`, params);
    ...
    ambari_alerts_getsummary: async (args) => {
        const clusterName = args['clusterName'] || await getClusterName();
        const excludeMaintenance = args['excludeMaintenance'];
        const params = {
    ...
    ambari_alerts_gethistory: async (args) => {
        ...
        if (args['state'])
            params['AlertHistory/state'] = args['state'];
        if (args['serviceName'])
            params['AlertHistory/service_name'] = args['serviceName'];
        if (args['hostName'])
            params['AlertHistory/host_name'] = args['hostName'];
        if (args['fromTimestamp'])
            params['AlertHistory/timestamp>='] = args['fromTimestamp'];
        if (args['toTimestamp'])
            params['AlertHistory/timestamp<='] = args['toTimestamp'];
        const data = await ambariGet(`/clusters/${clusterName}/alert_history`, params);
    ...
    ambari_alerts_getdefinitions: async (args) => {
        ...
        if (args['serviceName'])
            params['AlertDefinition/service_name'] = args['serviceName'];
        if (args['enabled'] !== undefined)
            params['AlertDefinition/enabled'] = args['enabled'];
...
//# sourceMappingURL=alert-tools.js.map