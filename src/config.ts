 ...
 */
function parseBaseUrl(url: string): { baseUrl: string; clusterName?: string } {
  // Normalize URL
 ...
 */
export function getAmbariConfig(): AmbariConfig {
...
export function getSshPrivateKeyPath(): string | undefined {
  ...
  if (!config.privateKeyPath) return undefined;
